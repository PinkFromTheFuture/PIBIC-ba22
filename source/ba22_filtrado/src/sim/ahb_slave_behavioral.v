...
/*path laico: */
// `include "C:/Dropbox/Bolsista Eduardo/ba22_filtrado/src/synth/common/ba22/ahb_master_defines.v"
// `include "C:/Dropbox/Bolsista Eduardo/ba22_filtrado/src/sim/bench_defines.v"

/*path casa: */
// `include "C:/Dropbox/TRABALHO/Bolsista Eduardo/ba22_filtrado/src/synth/common/ba22/ahb_master_defines.v"
// `include "C:/Dropbox/TRABALHO/Bolsista Eduardo/ba22_filtrado/src/sim/bench_defines.v"

/*path relativo: */
`include "../synth/common/ba22/ahb_master_defines.v"
`include "./bench_defines.v"
...
/*	always @ (data_phase or error or retry or ready or ahb_htrans_i or gnt_reg or retry_split)
    begin
        if (data_phase && error[0] || error[1])
            ahb_hresp <= `AHB_HRESP_ERROR  ;
        else if (data_phase && retry[0] || retry[1])
        ...
        if(random_bus_response) begin
            ...
            begin
                ...
                begin   
                    ...
                    dsize   <= ahb_hsize_i  ;
                    ddir    <= ahb_hwrite_i ;
                    dsel    <= sz2sel(ahb_haddr_i[ 1: 0], ahb_hsize_i)  ; //aparentemente o resultado de sz2sel é sempre 15
                end
...
//                if(gnt_reg & ahb_htrans_i !== `AHB_HTRANS_NONSEQ) cur_bsize   = cur_bsize + (1 << ahb_hsize_i) ;
    ...
    begin
        sz2sel  = 4'b0000   ;
        // repeat(1 << sz_i) // sz_i é sempre 2. logo fica:
		repeat(4)
